            ...
            <div className="container">
                <section className='section' id='main'>
                    <div className="s-text">
                        ...
                        <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"  x="0px" y="0px" viewBox="0 0 500 500" width={"200"} height={"200"} style={{position: 'absolute', bottom: '0', right: '0'}}>
                        ...
                        <path className="conf8" id="yellow-strip" d="M290.7,215.4c0,0-14.4-3.4-22.6,2.7c-8.2,6.2-8.2,23.3-17.1,29.4c-8.9,6.2-19.8-2.7-32.2-4.1c-12.3-1.4-19.2,5.5-20.5,10.9"/></g>
                        </svg>
                            <span className="t-line-1">25 ième anniversaire</span>
                        </h1>
